...
@EnableJpaRepositories("com.dibasb.repositories")
...
public class DBConfig {
	...
	public LocalSessionFactoryBean hibernateSessionFactory(DataSource dataSource) {
	    ...
	    sessionFactory.setPackagesToScan(new String[] { "com.dibasb.entities" }); //model package here
	...
	HibernateJpaVendorAdapter vendorAdapter = new HibernateJpaVendorAdapter();
	 ...
	 em.setPackagesToScan("com.dibasb.entities");
	...
	Properties hibernateProperties() {
	    return new Properties() {
			...
			private static final long serialVersionUID = -5267388222128246689L;
